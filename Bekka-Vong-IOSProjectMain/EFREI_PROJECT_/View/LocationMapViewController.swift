...
class LocationMapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        showdetailsButton.layer.borderColor = UIColor.init(named: "lightGray")?.cgColor
...
extension LocationMapViewController: UITableViewDelegate, UITableViewDataSource{
    ...
    func initializeEvents(){
        eventsTableView.backgroundColor = UIColor.init(named: "lightGray")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.layer.borderColor = UIColor.init(named: "black")?.cgColor
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerView.backgroundColor = UIColor.init(named: "lightGray")
        return headerView
    }
